    ...
    try {
      ...
      const options = {
        ...
        handler: async function (response: any) {
          // 2. Verify payment signature and update DB via edge function securely
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
        ...
        <motion.div 
          ...
          <div className="brutalist-card-front">
            ...
            <a 
              href="https://chromewebstore.google.com/detail/fkfiopkljlkagbkhcaodkiolceiokgig"
              target="_blank"
              rel="noreferrer"
              className="btn-brutalist-outline dark-variant"
              style={{ marginTop: 24, display: 'block', textAlign: 'center', textDecoration: 'none', boxSizing: 'border-box' }}
            >
              Add Extension
            </a>
          </div>
