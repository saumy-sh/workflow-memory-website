  ...
  return (
    <section id="pricing" ref={ref} style={{ padding: '100px 24px', position: 'relative' }}>
      ...
      >
        ...
        <p style={{ color: 'rgba(237,233,254,0.6)', maxWidth: 780, margin: '0 auto', fontSize: 15.5, lineHeight: 1.7, fontWeight: 300 }}>
      ...
      <div style={{ maxWidth: 1000, margin: '0 auto', display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: 20 }}>
        <div style={{ padding: 28, borderRadius: 16, background: 'rgba(13,10,26,0.6)', border: '1px solid rgba(255,255,255,0.06)' }}>
          ...
          <p style={{ color: 'rgba(237,233,254,0.5)', marginBottom: 12, lineHeight: 1.6 }}>
